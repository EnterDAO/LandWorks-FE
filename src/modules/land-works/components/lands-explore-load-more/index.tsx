...
const LoadMoreLands: React.FC<ILoadMore> = ({ handleLoadMore, percentageValue, textToDisplay, disabled }) => {
  return (
    <Grid container direction="column" alignItems="center" margin={'32px 0 36px'}>
