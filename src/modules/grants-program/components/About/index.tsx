...
export const About: React.FC = () => {
  return (
    <StyledRoot id={'gp-id-0'}>
      ...
      <Typography>
        For this first round of the grant program the grant pool will be 50,000 USDC + 50,000 ENTR given in 1:1 ratio.
        That would mean that whatever sum you get in USDC, it will be matched in ENTR tokens.
      </Typography>
      <br />
      <Typography>
